...
2. Start from a fitted model and let its `as_forest_data()` method or
   `ggforestplot()` create the validated forest data and plot.
...
- `ggforestplotR-data-helpers` for the `forest_data` contract,
  `as_forest_data()`, and `forest_metadata()`.
