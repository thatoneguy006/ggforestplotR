...
Parent-header interaction p-values are not synthesized in this release. The
canonical `p.value` is therefore blank for derived blocks, while each simple
effect test is retained in `effect.p.value` for users who choose to display it.
