...
## Mix standalone and hierarchical subgroup rows

Use `subgroup` when already-computed estimates include categorical levels that
should appear beneath a parent heading. Missing or empty subgroup values remain
ordinary standalone rows, so continuous covariates and subgroup blocks can be
shown together. Members of each subgroup must be contiguous in the input.
