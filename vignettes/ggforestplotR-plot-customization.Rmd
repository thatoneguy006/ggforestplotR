...
There are two ways to plot subgroup analyses using `ggforestplot()`. From a tibble, you can simply set `subgroup = "subgroup_variable_name"`. This functionality still works when some variables have subgroups and others don't, demonstrated here.
...
Notice how we are explicitly naming *p.value* column? This is necessary in most cases because aliases are not yet incorporated (but they will be...I promise I'm getting to it).
