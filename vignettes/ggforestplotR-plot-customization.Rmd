...
`subgroup` controls only the presentation of estimates you have already
computed. It does not detect categorical variables or calculate model
interaction contrasts automatically. If `p.value` is mapped, the first
